...
<main id="main-content">
    ...
    <div class="bg-surface py-4">
        <div class="container-custom">
            <nav class="text-sm text-text-muted" aria-label="<?php esc_attr_e('Breadcrumb', 'developer-developer'); ?>">
                <ol class="flex items-center gap-2">
                    <li><a href="<?php echo esc_url(home_url('/')); ?>" class="hover:text-secondary transition-colors"><?php esc_html_e('Inicio', 'developer-developer'); ?></a></li>
                    ...
                    <li><a href="<?php echo esc_url(home_url('/servicios/')); ?>" class="hover:text-secondary transition-colors"><?php esc_html_e('Servicios', 'developer-developer'); ?></a></li>
                    <li><svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"/></svg></li>
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="bg-surface rounded-xl p-8 text-center" data-animate="fade-up">
                    <h3 class="text-xl font-bold text-primary mb-3">
                        <?php esc_html_e('¿Necesitas este servicio?', 'developer-developer'); ?>
                    </h3>
                    <p class="text-text-muted mb-6">
                        <?php esc_html_e('Agenda una consulta para recibir atención especializada.', 'developer-developer'); ?>
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="<?php echo esc_url(home_url('/contacto/')); ?>" class="btn-primary">
                            <?php esc_html_e('Agendar Cita', 'developer-developer'); ?>
                        </a>
                        <a href="<?php echo esc_url(developer_get_whatsapp_url('Hola, me interesa el servicio de ' . get_the_title())); ?>" class="btn-whatsapp" target="_blank" rel="noopener">
