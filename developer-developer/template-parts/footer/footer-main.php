<footer class="bg-primary text-white">
    <div class="container-custom py-12 md:py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <!-- Column 1: About -->
            <div>
                <h3 class="text-lg font-semibold text-white mb-4"><?php echo esc_html(get_theme_mod('doctor_name', bloginfo('name'))); ?></h3>
                <p class="text-slate-300 text-sm leading-relaxed">
                    <?php echo esc_html(get_theme_mod('doctor_description', 'Médico Nefrólogo especialista en enfermedades renales con consultorios en Xalapa y Veracruz.')); ?>
                </p>
            </div>

            <!-- Column 2: Quick Links -->
            <div>
                <h3 class="text-lg font-semibold text-white mb-4"><?php esc_html_e('Enlaces', 'developer-developer'); ?></h3>
                <?php
                wp_nav_menu([
                    ...
                    'link_before'    => '<span class="text-slate-300 hover:text-white transition-colors text-sm">',
                    'link_after'     => '</span>',
                ]);
                ?>
            </div>
            ...
            <!-- Column 3: Xalapa -->
            <div>
                <h3 class="text-lg font-semibold text-white mb-4"><?php esc_html_e('Xalapa', 'developer-developer'); ?></h3>
                <address class="text-slate-300 text-sm not-italic leading-relaxed">
                    <?php echo nl2br(esc_html(get_theme_mod('address_xalapa', ''))); ?>
                </address>
            </div>

            <!-- Column 4: Veracruz -->
            <div>
                <h3 class="text-lg font-semibold text-white mb-4"><?php esc_html_e('Veracruz', 'developer-developer'); ?></h3>
                <address class="text-slate-300 text-sm not-italic leading-relaxed">
                    <?php echo nl2br(esc_html(get_theme_mod('address_veracruz', ''))); ?>
                </address>
            </div>
        </div>
        ...
        <div class="mt-8 pt-4 border-t border-slate-700 text-center">
            <p class="text-slate-400 text-xs">
                &copy; <?php echo date('Y'); ?> <?php echo esc_html(get_theme_mod('doctor_name', get_bloginfo('name'))); ?>. <?php esc_html_e('Todos los derechos reservados.', 'developer-developer'); ?>
            </p>
        </div>
    </div>
</footer>
