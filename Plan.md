...
>
> **Actualización PageSpeed 2026-07-09**: la rama aislada `codex/pagespeed-100` sube a tema 1.6.5. Agrega mapas Google bajo demanda, logos/retrato WebP más pequeños, variante de retrato `650w`, caché pública anónima de página en Nginx, CSS inline solo en Home, reserva explícita del retrato hero y orden DOM/visual estable para reducir CLS. Conserva la versión estable como respaldo y sigue pendiente verificar marcadores 100 antes de fusionar.
>
