...
### 2026-07-09 - Rama PageSpeed 1.6.5 con orden estable del hero

- Objetivo: eliminar el CLS residual de escritorio provocado por el cambio visual de columna del bloque del retrato en Lighthouse.
...
- Archivos modificados: `med-landing-dev/template-parts/sections/hero.php`, `med-landing-dev/assets/css/tailwind-output.css`, archivos de versión/build y documentación Markdown.
